...
void Connect(AuxDataStore *store, ulong x, ulong y) {
...
void Fuse(AuxDataStore *store, int self, int i) /* fuse regions [LWB(self), UPB(self+i-1)) and  [LWB(self+i), UPB(self+2i-1)) vertically */
{
  ulong q, p, x, y;
